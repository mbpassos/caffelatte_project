...
<form method="post" class="form-popup form-parsley" action="{{ route('process.download-pricelist') }}">

  <div class="row">

    <div class="form-popup-header col-12 mb-3">
        <h1>DOWNLOAD PRICELIST</h1>
    </div>

    {{ csrf_field() }}

    <input type="hidden" name="product_name" value="download pricelist"/>
    ...
    <div class="col-12">
        <button type="submit" id="request-price-tag" class="btn-request-piece btn-prevent-multiple"> DOWNLOAD PRICELIST</button>
    </div>
