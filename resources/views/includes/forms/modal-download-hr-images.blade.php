...
<form method="post" class="form-popup form-parsley" action="{{ route('process.download-hr-images') }}">

  <div class="row">

    <div class="form-popup-header col-12 mb-3">
        <h1>DOWNLOAD HR IMAGES</h1>
    </div>
    ...
    <div class="col-12">
        <button type="submit" id="request-price-tag" class="btn-request-piece btn-prevent-multiple"> DOWNLOAD IMAGES</button>
    </div>
