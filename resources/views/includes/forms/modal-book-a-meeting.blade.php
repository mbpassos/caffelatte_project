...
<form method="post" class="form-popup form-parsley" action="{{ route('process.book-a-meeting') }}">
  ...
  <div class="row">
    ...
    <input type="hidden" name="product_name" value="Maison&Objet Paris January 2020"/>
    ...
    <div class="col-12">
        <button type="submit" id="request-price-tag" class="btn-request-piece btn-prevent-multiple"> BOOK A MEETING</button>
    </div>
