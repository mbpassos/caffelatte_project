...
<form method="post" class="form-popup form-parsley" action="{{ route('process.download-brochure') }}">
  ...
  <div class="row">
    ...
    <input type="hidden" name="product_name" value="download brochure"/>
    ...
    <div class="col-12">
        <button type="submit" id="request-price-tag" class="btn-request-piece btn-prevent-multiple"> DOWNLOAD BROCHURE</button>
    </div>
